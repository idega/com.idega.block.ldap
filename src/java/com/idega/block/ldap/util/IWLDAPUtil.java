 ...
 */
package com.idega.block.ldap.util;
 ...
 *
 **/
public class IWLDAPUtil implements IWLDAPConstants,EmbeddedLDAPServerConstants,LDAPReplicationConstants, Singleton,LDAPInterface{
	...
	public Object getInstance() { return new IWLDAPUtil(); }};
	...
	public boolean isAutoSyncEnabled() {
		...
		return settings == null ? false : settings.getBoolean("ldap.auto_sync_enabled", false);
	}
...
//		directoryString.replaceAll("\\\\","\\\\");
	...
	public LDAPReplicationBusiness getLDAPReplicationBusiness(IWApplicationContext iwca) {
		if (ldapReplicationBiz == null) {
			try {
				ldapReplicationBiz = com.idega.business.IBOLookup.getServiceInstance(iwca, LDAPReplicationBusiness.class);
			} catch (java.rmi.RemoteException rme) {
				throw new RuntimeException(rme.getMessage());
			}
		}
