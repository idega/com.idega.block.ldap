...
public final class CBJarResource
{
    ...
    * into an internal hashtable, keyed by resource names.
    * @param zipFileName a jar or zip file
    * @param debug whether to dump the list of files found in the zip file.
    */
    ...
    * @returns a resource, or null if no resource available for any reason.
    */
   ...
   public static void main(String[] args) throws IOException {
       if (args.length!=2) {
          CBUtility.log("usage: java CBJarResources <jar file name> <resource name>");
          System.exit(1);
       }
